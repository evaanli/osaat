...
if (global.current_state == "replay" or global.current_state == "replaya" or global.current_state == "record1t" or global.current_state == "record1" or global.current_state == "record1a") {
    draw_set_alpha(image_alpha);
    // --- Bobbing arrow (V-shape, two lines) ---
    var dist_base = 70;          // base distance from player
    var bob_amp = 5;             // bobbing amplitude (pixels)
    var bob_speed = 6;           // bobbing cycles per second
